      ...
      <div className="pt-16 pl-20 p-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold dark:text-gray-100">Пользователи</h1>
            {auth.isAdmin && (
              <button 
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex space-x-2">
                            <div className="text-center px-2">
                              ...
                              <div className="font-medium dark:text-gray-100">{stats.total}</div>
                            </div>
                            <div className="text-center px-2">
                            ...
                            <div className="text-center px-2">
                              <div className="text-xs text-gray-500 dark:text-gray-400">На проверке</div>
